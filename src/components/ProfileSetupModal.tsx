...
export const ProfileSetupModal: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs animate-fade-in overflow-y-auto"
    >
      <div
        ...
        className="w-full max-w-lg rounded-3xl bg-white p-6 shadow-2xl border border-gray-200 animate-scale-in my-8 text-[#1F2421]"
      >
        {/* Header */}
        <div className="border-b border-gray-100 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 id="profile-setup-title" className="text-lg font-bold text-gray-900 leading-tight">
                Let's set up your health profile
              </h2>
              <p className="text-xs text-gray-500">
                This helps SwasthAI personalize your health tracking.
              </p>
            </div>
          </div>
        ...
        {step === 1 && (
          <form onSubmit={handleNextFromStep1} className="mt-5 space-y-4">
            <div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. 28"
                className={`mt-1.5 w-full rounded-xl border py-2 px-3 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-hidden focus:ring-2 ${
                  errors.age
                    ? 'border-red-400 focus:ring-red-200'
                    : 'border-gray-300 focus:border-[#15803D] focus:ring-green-100'
                }`}
        ...
        {step === 2 && (
          <form onSubmit={handleNextFromStep2} className="mt-5 space-y-4">
            <div>
        ...
        {step === 3 && (
          <form onSubmit={handleNextFromStep3} className="mt-5 space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-xl border border-gray-300 py-2 px-3 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-hidden focus:border-[#15803D] focus:ring-2 focus:ring-green-100"
              />
            </div>
          ...
          <div className="mt-5 space-y-4">
            <div className="rounded-2xl bg-[#F8F7F2] p-4 text-xs text-gray-700 border border-[#EAE7DE] space-y-3">
              ...
              <ul className="space-y-2 list-disc pl-4 text-gray-600 text-[11px] leading-relaxed">
                <li>
                  <strong className="text-gray-800">Non-Diagnostic Screening:</strong> SwasthAI provides wellness trend tracking and objective physiological estimations. It does not replace clinical evaluation or diagnostic hospital telemetry.
                </li>
                <li>
